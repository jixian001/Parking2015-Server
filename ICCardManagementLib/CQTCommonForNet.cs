...
namespace ICCardManagementLib
{
    ...
    public class CQTCommonForNet
    {
        ...
        [DllImport("RFBOOK.dll", EntryPoint = "rf_init", SetLastError = true,
        ...
        [DllImport("RFBOOK.dll", EntryPoint = "rf_exit", SetLastError = true,
         CharSet = CharSet.Auto, ExactSpelling = false,
         CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport("RFBOOK.dll", EntryPoint = "rf_beep", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport("RFBOOK.dll", EntryPoint = "rf_load_key", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        ...
        /// <returns>0: 成功</returns>
        [DllImport("RFBOOK.dll", EntryPoint = "a_hex", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        ...
        /// <returns>0: 成功</returns>
        [DllImport("RFBOOK.dll", EntryPoint = "hex_a", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        //说明：     返回设备当前状态
        ...
        /// <returns>0: 成功</returns>
        [DllImport("RFBOOK.dll", EntryPoint = "rf_reset", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        ...
        /// <returns>0: 成功</returns>
        [DllImport("RFBOOK.dll", EntryPoint = "rf_request", SetLastError = true,
            CharSet = CharSet.Auto, ExactSpelling = false,
            CallingConvention = CallingConvention.StdCall)]
        public static extern Int16 rf_request(int icdev, int Mode, out Int16 tagtype);
        ...
        /// <returns>0: 成功</returns>
        [DllImport("RFBOOK.dll", EntryPoint = "rf_anticoll", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport("RFBOOK.dll", EntryPoint = "rf_select", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        ...
        /// <returns>0-表示成功</returns>
        [DllImport("RFBOOK.dll", EntryPoint = "rf_authentication", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        ...
        /// <returns>0-表示成功</returns>
        [DllImport("RFBOOK.dll", EntryPoint = "rf_read", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        ...
        /// <returns>0: 成功</returns>
        [DllImport("RFBOOK.dll", EntryPoint = "rf_write", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        ...
        /// <param name="icdev">rf_init()返回的设备描述符</param>
        /// <returns>0-表示成功</returns>
        [DllImport("RFBOOK.dll", EntryPoint = "rf_halt", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
