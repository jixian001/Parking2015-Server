...
namespace CommonMethodLib
{
    ...
    public class CMainCallback
    {
        ...
        private CMainEventArgs e;
        public CMainCallback()
        {
            e = new CMainEventArgs();
        }
        /// <summary>
        /// 推送消息到WCF服务
        /// </summary>
        ...
        {
            System.Threading.ThreadPool.QueueUserWorkItem(new System.Threading.WaitCallback(PushMessageToWCFPool), objTable);
        }
        ...
        /// </summary>
        /// <param name="text"></param>
        private void PushMessageToWCFPool(object objTable)
        {
            try
            {
